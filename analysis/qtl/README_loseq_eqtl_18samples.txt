# eQTL replication in 18 samples of hair, buccal, and urine tissues
...
#######  Permutation mode --> edit geno path in script

mkdir analysis/qtl/loseq18/cis
FILES=($(find analysis/qtl/loseq18/counts_files/ -name "*.normalized_expression.bed.gz"))
COV_ENDING='.covariates.txt'
COV_PATH='analysis/qtl/loseq18/covs/'
...
mkdir -p analysis/qtl/loseq18/cis/allpairs
FILES=($(find analysis/qtl/loseq18/counts_files/ -name "*.normalized_expression.bed.gz"))
...
Manually run analysis/qtl/loseq18/eqtl_replication_analysis.Rmd
