...
2. Get normalized counts in BED format
...
OUT_DIR='analysis/qtl/counts_files/'
...
LINKING_FILE='data/210817_samplekey_485.txt'
...
FILES=($(find analysis/qtl/counts_files/ -name "*.bed"))
...
FILES=($(find analysis/qtl/counts_files/ -name "*.deseq_log2_expression.bed"))
...
TPM_END='_maxdepthsamps_tpms.txt'
CTS_END='_maxdepthsamps_raw.txt'
CTS_DIR='analysis/qtl/counts_files/'
OUT_DIR='analysis/qtl/covs/'
...
GENO_COV='analysis/qtl/covs/loseq.genotype.covariates.txt'
